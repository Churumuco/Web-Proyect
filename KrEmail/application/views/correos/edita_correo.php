  <center>
    ...
    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>correo/updateCorreo/?cid=<?php
    echo $e['id'];?>">
    ...
    <div class="form-group">
      <div class="col-sm-offset-4 col-xs-4" >
        ...
        <a class="btn btn-danger btn-lg btn-block" href="<?php echo base_url();?>correo/vistaCorreo/">Cancelar</a>
        </div>
      </div>
